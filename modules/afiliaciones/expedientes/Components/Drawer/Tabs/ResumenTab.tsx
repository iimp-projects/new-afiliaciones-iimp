...
const formatStatusName = (status: string) => {
  ...
  const map: Record<string, string> = {
    ...
    UNDER_EVALUATION: "En Evaluación", OBSERVED: "Observado", RESOLVED: "Subsanado",
    READY_FOR_PAYMENT: "Apto para Pago", COMPLETED: "Completado", REJECTED: "Rechazado", APPROVED: "Aprobado"
  };
  return map[status.toUpperCase().trim()] || status.replace(/_/g, " ");
};
...
export function ResumenTab({ header, payload, isStudent }: ResumenTabProps) {
