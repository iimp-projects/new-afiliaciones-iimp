    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        <div className="flex justify-between items-center mb-2 ml-1">
          ...
          <span className="text-[10px] font-bold text-primary-container bg-primary-container/10 px-2 py-0.5 rounded-md border border-primary-container/20">
            Requerido
          </span>
        </div>
        <div className="relative group">
          ...
          <input
            ...
            className="w-full h-12 pl-11 pr-4 bg-surface border border-outline-variant rounded-xl text-sm text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-mono tracking-wide placeholder-secondary/50 placeholder:font-sans placeholder:tracking-normal"
            required
            disabled={loading}
          />
        </div>
