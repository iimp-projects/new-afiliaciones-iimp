    ...
    <>
      ...
      >
        ...
        <div className="h-20 flex items-center justify-center px-4 border-b border-slate-100 shrink-0 relative overflow-hidden">
          <img
            src={
              isCollapsed ? "/images/logo-iimp.png" : "/images/logo-iimp.png"
            }
            alt="IIMP Logo"
        ...
        <div
          className={`p-4 border-t border-slate-100 bg-white shrink-0 transition-all duration-300 ${isCollapsed ? "px-2" : "px-4"}`}
        >
          {/* <button 
