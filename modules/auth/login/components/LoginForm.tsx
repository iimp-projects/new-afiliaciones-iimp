...
export function LoginForm() {
  ...
  return (
    <>
      {error && (
        <div className="p-4 mb-5 text-sm font-bold text-red-800 bg-red-100 border border-red-300 rounded-xl flex items-start justify-between shadow-sm animate-in fade-in slide-in-from-top-2">
          ...
          <button
            onClick={clearError}
            type="button"
            className="text-red-500 hover:text-red-800 transition-colors p-1 rounded-md hover:bg-red-200 focus:outline-none"
            title="Cerrar alerta"
          >
            <svg
              className="w-5 h-5"
