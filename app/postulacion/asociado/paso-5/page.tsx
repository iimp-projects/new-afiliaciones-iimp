...
export default function PasoCincoPage() {
    ...
    <div className="w-full min-h-screen bg-[#F7F8FA] relative font-sans antialiased flex flex-col">
      ...
      <div className="relative z-20 flex flex-col flex-1">
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-6 w-full max-w-3xl mx-auto pb-20">
          ...
          <section className="bg-white rounded-[32px] border border-gray-200 shadow-2xl overflow-hidden text-center relative w-full">
            ...
            <div className="p-8 sm:p-16">
              ...
              <p className="text-lg text-gray-500 font-medium mb-10 max-w-xl mx-auto leading-relaxed">
                Su expediente de postulación como Asociado Activo ha sido registrado exitosamente en la plataforma del Instituto de Ingenieros de Minas del Perú.
              </p>

              {/* CAJA DE PRÓXIMOS PASOS */}
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-gray-600 font-medium leading-relaxed">
                      Su expediente pasará a una <strong>revisión detallada por nuestro personal administrativo y el Consejo Directivo</strong>, quienes validarán sus avales y la Declaración Jurada.
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-white border border-gray-200 flex items-center justify-center shrink-0 mt-0.5 shadow-sm">
                    ...
                    <p className="text-sm text-gray-600 font-medium leading-relaxed">
                      Este proceso de evaluación corporativa tiene un tiempo estimado de <strong>3 a 5 días hábiles</strong>.
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-white border border-gray-200 flex items-center justify-center shrink-0 mt-0.5 shadow-sm">
                    ...
                    <p className="text-sm text-gray-600 font-medium leading-relaxed">
                      Recibirá una notificación oficial en su correo electrónico informándole sobre el estado de aprobación y los <strong>pasos para realizar el pago de su membresía</strong>.
                    </p>
                  </li>
                </ul>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                {/* Usamos push aquí porque ya es el final, los manda fuera del form */}
                <button
                  onClick={() => router.push('/')}
